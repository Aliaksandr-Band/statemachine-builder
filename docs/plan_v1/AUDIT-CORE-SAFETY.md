...
### AUDIT-CRITICAL-1: ConcurrentModificationException в notify-методах
...
### AUDIT-SERIOUS-1: NPE в doStart() при некорректной конфигурации
...
1. **Срочно:** AUDIT-CRITICAL-1 (ConcurrentModification в notify-методах)
...
Основные проблемы:
1. **ConcurrentModification** в notify-методах (P0)
